    ...
    return (
        <div className='col-span-1 border p-4 rounded-xl'>
            ...
            <div className='flex justify-between'>
                <h5 className='text-lg text-[#131313] font-medium my-2'>{batting_style}</h5>
            ...
            <div className='flex justify-between'>
                ...
                <button className='bg-[#1313130D] py-2 px-3 text-sm text-[#131313B3] font-normal rounded-md' onClick={()=>handleSeclect(player)}>Choose Player</button>
